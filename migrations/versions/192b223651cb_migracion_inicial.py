...
Revision ID: 192b223651cb
Revises: 
Create Date: 2024-12-12 19:18:59.808861
...
def upgrade_mysql():
    ...
    sa.Column('tipoUsuario', sa.Enum('ADMIN', 'CLIENTE', 'EMPLEADO', name='tipousuario'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
